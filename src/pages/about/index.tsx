  ...
  return (
    <>
      ...
      <Block sx={{ display: "grid", rowGap: "10px" }}>
        ...
        <Typography>
          В Hayat Crypto мы понимаем, насколько важен для вас комфорт при обмене
          валюты. Именно поэтому мы предлагаем удобные решения, которые отвечают
          вашим потребностям. Независимо от того, где вы находитесь, с нами вы
          всегда можете рассчитывать на прозрачные условия, конкурентные курсы и
